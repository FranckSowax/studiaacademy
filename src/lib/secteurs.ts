...
export const SECTEURS: Secteur[] = [
  ...
  {
    slug: 'juridique',
    label: 'Notaire, Huissier & Juriste',
    iconName: 'Scale',
    couleur: '#4F46E5',
    cover: '/secteurs/juridique.png',
    accroche: "Rédigez et traitez vos actes plus vite avec l'IA",
    description: "Rédaction d'actes, synthèse de dossiers, contrats : l'IA fait gagner un temps précieux aux professionnels du droit (modèles à valider).",
    outils: ['courrier-admin', 'resume-document', 'contrat-type', 'reglement-interieur'],
    formations: [
      { slug: 'jur-redaction-actes', titre: "Rédiger actes et courriers juridiques avec l'IA", pitch: "Produisez des projets d'actes et courriers fiables, plus vite.", arguments: ["Brouillons d'actes en minutes", "Formulations professionnelles", "Modèles à valider par le praticien"], format: 'En ligne', niveau: 'Initiation', prix_fcfa: 85000, cover: '/secteurs/jur-actes.png' },
      { slug: 'jur-synthese-dossiers', titre: "Analyser et synthétiser des dossiers", pitch: "Résumez de longs documents juridiques et gagnez en clarté.", arguments: ["Synthèses fidèles et structurées", "Points juridiques mis en évidence", "Traitement plus rapide des dossiers"], format: 'En ligne', niveau: 'Intermédiaire', prix_fcfa: 80000, cover: '/secteurs/jur-synthese.png' },
      { slug: 'jur-contrats-modeles', titre: "Modèles de contrats et conventions", pitch: "Générez des trames de contrats adaptées à vos besoins.", arguments: ["Trames complètes et claires", "Clauses essentielles couvertes", "Gain de temps sur la rédaction"], format: 'En ligne', niveau: 'Intermédiaire', prix_fcfa: 90000, cover: '/secteurs/jur-contrats.png' },
      { slug: 'jur-relation-client', titre: "Communication & suivi client au cabinet", pitch: "Améliorez l'accueil, le suivi et la communication avec vos clients.", arguments: ["Courriers et e-mails pro", "Explications claires aux clients", "Image de cabinet renforcée"], format: 'Hybride', niveau: 'Initiation', prix_fcfa: 65000, cover: '/secteurs/jur-relation.png' },
    ],
  },
  {
    slug: 'services',
